      ...
      <section className="contact-page">
        <div className="section-container contact-layout">
          <div className="contact-copy">
            ...
            <h1>Spune-ne ce vrei<br />să rezolvi.</h1>
            <p>Îți răspundem cu întrebările potrivite, o evaluare inițială și următorii pași concreți.</p>
            ...
            <div className="contact-steps" aria-label="Cum decurge prima discuție">
