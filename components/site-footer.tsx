  ...
  return (
    <footer className="site-footer">
      <div className="section-container footer-main">
        ...
        <div>
          <h3>Direcții de finanțare și administrare</h3>
          <a href="/fonduri-europene" aria-label="Consultanță fonduri europene ProBirou" title="Consultanță fonduri europene">Fonduri europene</a>
          <a href="/servicii-administrative" aria-label="Servicii administrative externalizate ProBirou" title="Servicii administrative externalizate">Servicii administrative</a>
          <a href="/servicii-administrative#infiintare-firma" aria-label="Servicii pentru înființare firmă ProBirou" title="Înființare firmă">Înființare firmă</a>
        </div>
        <div>
