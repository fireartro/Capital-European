...
import { getGoogleBusinessReviews, type GoogleBusinessReview } from "@/lib/google-business-reviews";
...
export async function GoogleReviewsSection({ variant = "default" }: { variant?: "default" | "split" | "compact" }) {
