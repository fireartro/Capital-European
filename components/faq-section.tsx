    ...
    <section className="section faq" id="faq" aria-labelledby="general-faq-title" aria-describedby="general-faq-description">
      <div className="shell faq-layout">
        <div className="faq-intro">
          ...
          <h2 id="general-faq-title">Ce merită lămurit înainte de contact</h2>
          <p id="general-faq-description">Dacă situația ta nu apare aici, trimite o descriere scurtă prin formular.</p>
