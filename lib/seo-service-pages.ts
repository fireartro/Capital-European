export type SeoServicePageConfig = {
  ...
  contactService: "fonduri-europene" | "servicii-administrative" | "secretariat" | "documente" | "infiintare-firma" | "infiintare-pfa" | "infiintare-srl";
  serviceType: string[];
...
export const seoServicePages = {
  ...
  startup: {
    ...
    related: [
      { href: "/servicii-administrative/infiintare-pfa", label: "Înființare PFA", text: "Pașii administrativi pentru activitatea independentă." },
      { href: "/servicii-administrative/infiintare-srl", label: "Înființare SRL", text: "Pașii administrativi pentru înregistrarea societății." },
  ...
  secretariat: {
    ...
    related: [
      ...
      { href: "/servicii-administrative/infiintare-pfa", label: "Înființare PFA", text: "Sprijin administrativ pentru o activitate independentă." },
      { href: "/servicii-administrative/infiintare-srl", label: "Înființare SRL", text: "Sprijin administrativ pentru o societate nouă." },
  ...
  companySetup: {
    ...
    steps: [
      { title: "Descrii activitatea", text: "Ne spui ce vei face, unde va fi sediul și cine va participa la activitate." },
      { title: "Comparăm traseele", text: "Îți prezentăm diferențele administrative dintre PFA și SRL și marcăm deciziile care cer validare specializată." },
      { title: "Alegi și validezi", text: "Confirmi forma potrivită după ce ai toate informațiile administrative, fiscale și juridice relevante." },
      { title: "Organizăm dosarul", text: "Centralizăm documentele, verificăm concordanța datelor și urmărim pașii de înregistrare." }
    ],
    faq: [
